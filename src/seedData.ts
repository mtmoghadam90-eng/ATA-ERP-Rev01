...
export const DEFAULT_SETTINGS: ERPSettings = {
  ...
  dropdownItems: {
    ...
    projectStatuses: ['جدید', 'در حال مذاکره', 'ارائه پیش‌فاکتور', 'ارائه پیش‌فاکتور فنی', 'تأیید پیشنهاد فنی', 'برنده (موفق)', 'باخته', 'لغو شده', 'نیمه برنده'],
    ...
    communicationMethods: ['تلفن', 'ایمیل', 'جلسه حضوری', 'مکاتبه رسمی', 'شبکه‌های اجتماعی', 'وب‌سایت'],
