...
> **هر ده ماژول پشتیبانی می‌شوند.** «بسته‌بندی و تحویل کالا» و «خدمات پس از فروش» تا مدتی استثنا بودند: صفحه‌ی تنظیمات اجازه می‌داد برایشان فیلد تعریف کنید ولی هیچ جدولی جای نگهداری مقدار نداشت. حالا هر دو ستون `customValues` دارند، فرم‌هایشان بخش فیلد سفارشی دارد، و مقادیرشان در `custom_field_values` می‌آید.
